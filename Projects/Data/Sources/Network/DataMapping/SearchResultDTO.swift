...
extension SearchResponseDTO {
    struct SearchResultDTO: Codable {
        ...
        let minimumOSVersion, description: String
        ...
        enum CodingKeys: String, CodingKey {
            case advisories, isGameCenterEnabled, supportedDevices, features, screenshotUrls, ipadScreenshotUrls, appletvScreenshotUrls, artworkUrl60, artworkUrl512, artworkUrl100
            case artistViewURL = "artistViewUrl"
            case kind, currentVersionReleaseDate
            case minimumOSVersion = "minimumOsVersion"
            case description, isVppDeviceBasedLicensingEnabled
            case bundleID = "bundleId"
            case releaseDate, sellerName, releaseNotes, primaryGenreName
            case primaryGenreID = "primaryGenreId"
            case genreIDS = "genreIds"
            case trackID = "trackId"
            case trackName, trackCensoredName, languageCodesISO2A, fileSizeBytes
            ...
            case trackContentRating, currency, price
